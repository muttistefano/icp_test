...
class CNN(nn.Module):
    def __init__(self):
        ...
        self.cnn2 = nn.Conv2d(1,20,kernel_size=10,stride=5,padding=0)
        self.bn2  = nn.BatchNorm2d(20)
        self.fc   = nn.Linear(in_features=6060,out_features=3030)
        self.fc2  = nn.Linear(in_features=3030,out_features=1000)
